...
TIP: My first Python Tuetorial, if you find a error or you have a suggestion to improve this documentation feel free to open a issue or clone this repository and send me a Pull Reqquest with your change
