...
-- 					AND Cnte.TIPOPERSONAFISCALID			 in (1, 3)	 --Tipo de Persona Física
					AND Cnte.TIPOPERSONAFISCALID			 in (?)	 --Tipo de Persona Física -- pARáMETRO DESDE PANTALLA PARA LOS QUE SON CL
...
-- 				    AND Oper.MONTOMNCNTR                     >  ? -- Parámetro Monto Persona Física
				    AND Oper.MONTOUSD                     >  ? -- Parámetro Monto Persona Física
