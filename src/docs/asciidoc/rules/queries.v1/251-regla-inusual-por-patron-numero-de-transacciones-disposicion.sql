  -- PARAMETROS REGLA  v1.1
			            ...
			            SELECT Oper.OPERCNTRID, CONTPROM,NUMTRANS
			                  ,Oper.NUMPOLIZACNTR
			            ...
			            FROM (
			                  ...
			                  ,(SELECT sum(REGISTROS)   
								FROM    (--  Parametro de porcentaje en este caso 1.5% -- Se elimina el parametro
			                        SELECT  COUNT(1) Registros -- Cuenta los registros de los últimos 30 dias a partir de la fecha de operación anlizada
...
-- 									  AND OPE.TIPOOPERACIONID = 40 -- Se agrega tipo de operación de entrada
									  AND OPE.TIPOOPERACIONID = ? -- Se agrega tipo de operación de entrada
						...
						AND OPER2.TIPOOPERACIONID = ? -- Se agrega tipo de operación de entrada
			            ...
			            AND Oper.NUMTRANS >= (Oper.CONTPROM * desviciacion) -- validar parámetro de desviación
